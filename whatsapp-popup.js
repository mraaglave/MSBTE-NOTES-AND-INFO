(function () {
    ...
    <div id="whatsappPopup"
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-sm mx-4 text-center transform transition-all scale-95">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2" style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem;">🚀 Internship Opportunity – Only ₹999!</h3>
            <p class="text-gray-600 mb-1" style="color: #111827; font-weight: 600; margin-bottom: 0.25rem;">NotWorking EduTech Startup</p>
            <p class="text-gray-600 mb-4" style="color: #4b5563; margin-bottom: 1rem; font-size: 0.9rem;">Internship starts <strong>after your exams</strong> — no impact on studies! Get real startup experience, verified LOR &amp; professional certificate.</p>
            <div style="background: #f0fdf4; border: 1px solid #bbf7d0; border-radius: 0.75rem; padding: 0.6rem 1rem; margin-bottom: 1rem; font-size: 0.85rem; color: #065f46;">
                ✅ Real Work &nbsp;|&nbsp; ✅ LOR &nbsp;|&nbsp; ✅ Certificate &nbsp;|&nbsp; ✅ Career Guidance
            </div>
            <!-- ...benefits strip above... -->

            <p style="font-size: 0.75rem; color: #ef4444; margin-bottom: 1rem; background: #fef2f2; border: 1px solid #fecaca; border-radius: 0.5rem; padding: 0.5rem 0.75rem; line-height: 1.5;">
                🚫 Free internship शोधणाऱ्या विद्यार्थ्यांनी apply करू नये — हा program <strong>quality learning</strong> आणि <strong>real growth</strong> साठी आहे.
            </p>

            <div class="space-y-3" style="display: flex; flex-direction: column; gap: 0.75rem;">
                <!-- ...buttons below... -->
            <div class="space-y-3" style="display: flex; flex-direction: column; gap: 0.75rem;">
                <a href="https://chat.whatsapp.com/Ka5LNIQLsvqARwygpJLmwf" target="_blank"
                    id="joinWhatsappBtn"
