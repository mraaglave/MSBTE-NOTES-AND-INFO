(function () {
    ...
    <div id="whatsappPopup"
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-6 max-w-sm mx-4 text-center transform transition-all scale-95">
            ...
            <h3 class="text-xl font-bold text-gray-900 mb-2" style="font-size: 1.25rem; font-weight: 700; color: #111827; margin-bottom: 0.5rem;">Join Our Student Community</h3>
            <p class="text-gray-600 mb-6" style="color: #4b5563; margin-bottom: 1.5rem;">Get the latest MSBTE updates, notes, and exam tips directly on WhatsApp!</p>
